...
def update_config(config, args):
    ...
    if _check_args('depth_data_path'):
        config.DATA.DEPTH_DATA_PATH = args.depth_data_path
    if _check_args('file_name_path'):
        config.DATA.FILE_NAME_PATH = args.file_name_path
