...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None, D=2):
        super().__init__()
        self.conv1 = MinkowskiConvolution(in_channels, out_channels, kernel_size=3, stride=stride, bias=False,
                                          dimension=D)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None, D=2):
        ...
        self.norm1 = MinkowskiLayerNorm(out_channels, eps=1e-6)
        self.conv2 = MinkowskiConvolution(out_channels, out_channels, kernel_size=3, stride=stride, bias=False,
                                          dimension=D)
        self.norm2 = MinkowskiLayerNorm(out_channels, eps=1e-6)
        self.conv3 = MinkowskiConvolution(out_channels, out_channels * self.expansion, kernel_size=1, bias=False,
                                          dimension=D)
